(function () {
	...
	(function (global, factory) {
	  ...
	  var nextTick = function () {
	    ...
	    if (typeof MutationObserver !== 'undefined' && !hasMutationObserverBug) {
	      ...
	      var context = inBrowser ? window : typeof commonjsGlobal !== 'undefined' ? commonjsGlobal : {};
	...
	var fecha$1 = interopDefault(fecha);
	...
	var striptags$1 = interopDefault(striptags);
	...
	var truncate$1 = interopDefault(truncate);
	...
	var fetchival = interopDefault(index);
	...
	Vue.filter('date', function (dateStr) {
	  return dateStr
	    ? fecha$1.format(new Date(dateStr), 'DD MMM YYYY')
	    : ''
	})
	...
	window.vm = new Vue({
	  ...
	  methods: {
	    filterHtml: function (html) {
	      return truncate$1(striptags$1(html), 100)
	    }
	  }
	})
